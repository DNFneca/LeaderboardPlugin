...
public class BlocksMinedGUI extends BaseBoardGUI {

    public BlocksMinedGUI(String title, int size, List<ItemStack> items) {
        super(title, size, items);
    }

    public BlocksMinedGUI(String title, int size) {
        super(title, size);

        setItem(4, ItemUtils.makeGUIItemOfType(Material.GRASS_BLOCK, "Placed Blocks"));
    ...
    public BlocksMinedGUI(String title, int size, Material material) {
        super(title, size);
